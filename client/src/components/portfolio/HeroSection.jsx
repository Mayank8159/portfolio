      ...
      <div className="flex w-full max-w-3xl flex-col items-center gap-6 text-center lg:flex-row lg:gap-10 lg:items-start lg:text-left">
        <div className="shrink-0">
          <div className="relative flex items-start">
            <div className="absolute -inset-10 rounded-full bg-gradient-to-t from-orange-500/25 via-red-500/15 to-transparent blur-3xl animate-flame-glow" />
            <div className="absolute -inset-6 rounded-full bg-gradient-to-b from-amber-400/20 via-orange-500/10 to-transparent blur-2xl animate-flame-flicker" />
            <div className="absolute -inset-[3px] rounded-full bg-gradient-to-b from-orange-400 via-red-500 to-amber-300 animate-ring-spin" />
            <div className="relative h-28 w-28 overflow-hidden rounded-full sm:h-32 sm:w-32 lg:h-44 lg:w-44">
              <Image
                src="/profilePic.jpeg"
                alt="Mayank Sharma"
                fill
